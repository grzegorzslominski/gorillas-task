...
async function main() {
  ...
  const ground = new THREE.Mesh(
    new THREE.PlaneGeometry(100, 100).applyMatrix4(
  ...
  diamond.scale.copy(new Vector3(2, 2, 2));
  scene.add(diamond);
  ...
  gui
    .add(effectController, "aberrationStrength", 0.0, 1.0, 0.0001)
  ...
  function animate() {
    ...
    diamond.material.uniforms.chromaticAberration.value =
      effectController.chromaticAberration;
    diamond.material.uniforms.aberrationStrength.value =
      effectController.aberrationStrength;
